      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 rounded-lg border border-border bg-muted/30 p-4 text-sm text-muted-foreground">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            <li>預設回測五年，樣本仍只限於後端觀察清單（100 檔股本 &lt; 40 億、依流動性排名取前 100 的中小型股）；訊號數少時不可只看勝率</li>
            ...
            <li>
              ...
              跟即時掃描是同一套四條件；觀察清單是用「今天」的股本與流動性選出的
              100 檔，不是回測起點當天真實存在的中小型股全集，仍有一定存活者偏誤
            </li>
            <li>短期（5 個交易日）平均報酬統計上偏弱甚至為負，這套規則比較適合抱到接近 20 個交易日的波段思維，不建議當短線工具</li>
          </ul>
        </div>
